...
export default function MarkerComponent({ event, token }) {
  ...
  function fetchMarkerLikes() {
    fetch("http://besocial.alumnes.inspedralbes.cat/public/api/get-like", {
      method: "GET",
      headers: {
  ...
  function fetchMarkerAssists() {
    fetch("http://besocial.alumnes.inspedralbes.cat/public/api/get-assist", {
      method: "GET",
      headers: {
        Accept: "application/json",
        Authorization: `Bearer ${token}`,
  ...
  function fetchTotalLikes() {
    ...
    fetch("http://besocial.alumnes.inspedralbes.cat/public/api/getAllLikes", {
      method: "POST",
  ...
  function toggleLike() {
    ...
    fetch(`http://besocial.alumnes.inspedralbes.cat/public/api/${endpoint}`, {
      method: "POST",
      body: likeFormData,
      headers: {
        Accept: "application/json",
