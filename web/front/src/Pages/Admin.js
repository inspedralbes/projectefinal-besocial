                            ...
                            <table className="w-full text-sm text-left dark:text-gray-400 text-slate-300">
                                {organizers.map((organizer, i) => (
                                    <tr key={i}>
                                        ...
                                        <td className="px-6 py-4"><Link to="/editOrganizer" className="h-fit bg-[#ab4bc5] text-slate-900 p-1 px-2 rounded-lg hover:scale-105 ease-in-out duration-150">Edit</Link></td>
                                    </tr>
                                ))}
                            </table>
                        </div>
