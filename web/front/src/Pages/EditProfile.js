      ...
      <div className="w-full">
        <div className="flex flex-col items-center justify-center m-6">
          <div className="avatar indicator rounded-full group/pfp ">
            {/* <span className="indicator-item badge badge-primary rounded-full h-12 w-12 top-12 left-56 invisible group-hover/pfp:visible">
          ...
          <div className="indicator">
            {/* <span className="indicator-item badge badge-primary rounded-full h-10 w-10 top-8">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
